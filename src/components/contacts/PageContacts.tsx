  ...
  return (
    <>
     <main className="bg-background-homepage h-[100%] w-full flex flex-col gap-[90px] ">
      <h2 className="font-[julius_Sans_One] text-[25px] md:text-[35px] lg:text-[50px] text-default-text pt-[30px] ml-[30px]">{t('contacts.title')}</h2>
      ...
      <p className="text-center font-['josefin_Sans'] text-[16px] md:text-[20px] lg:text-[25px] text-highlighted-text ">{t('contacts.message')}</p>
     </main>
    </>
  );
}
